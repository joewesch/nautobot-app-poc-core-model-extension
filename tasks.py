...
def pylint(context):
    ...
    command = 'pylint --init-hook "import nautobot; nautobot.setup()" --rcfile pyproject.toml poc_core_model_extension'
    run_command(context, command)
...
def unittest(context, keepdb=False, label="poc_core_model_extension", failfast=False, buffer=True):
