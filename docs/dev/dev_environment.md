...
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 1.5.18)
- `project_name`: the default docker compose project name (default: `poc_core_model_extension`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_POC_CORE_MODEL_EXTENSION_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/poc-core-model-extension/nautobot:1.5.18-py3.7 done
```
...
Creating network "poc_core_model_extension_default" with the default driver
Creating volume "poc_core_model_extension_postgres_data" with default driver
Creating poc_core_model_extension_redis_1 ...
Creating poc_core_model_extension_docs_1  ...
Creating poc_core_model_extension_postgres_1 ...
Creating poc_core_model_extension_postgres_1 ... done
Creating poc_core_model_extension_redis_1    ... done
Creating poc_core_model_extension_nautobot_1 ...
Creating poc_core_model_extension_docs_1     ... done
Creating poc_core_model_extension_nautobot_1 ... done
Creating poc_core_model_extension_worker_1   ...
Creating poc_core_model_extension_worker_1   ... done
...
ee90fbfabd77   poc-core-model-extension/nautobot:1.5.18-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               poc_core_model_extension_worker_1
b8adb781d013   poc-core-model-extension/nautobot:1.5.18-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   poc_core_model_extension_nautobot_1
d64ebd60675d   poc-core-model-extension/nautobot:1.5.18-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   poc_core_model_extension_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   poc_core_model_extension_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   poc_core_model_extension_redis_1
```
...
Stopping poc_core_model_extension_worker_1   ...
Stopping poc_core_model_extension_nautobot_1 ...
Stopping poc_core_model_extension_docs_1     ...
Stopping poc_core_model_extension_redis_1    ...
Stopping poc_core_model_extension_postgres_1 ...
Stopping poc_core_model_extension_worker_1   ... done
Stopping poc_core_model_extension_nautobot_1 ... done
Stopping poc_core_model_extension_postgres_1 ... done
Stopping poc_core_model_extension_redis_1    ... done
Stopping poc_core_model_extension_docs_1     ... done
Removing poc_core_model_extension_worker_1   ...
Removing poc_core_model_extension_nautobot_1 ...
Removing poc_core_model_extension_docs_1     ...
Removing poc_core_model_extension_redis_1    ...
Removing poc_core_model_extension_postgres_1 ...
Removing poc_core_model_extension_postgres_1 ... done
Removing poc_core_model_extension_docs_1     ... done
Removing poc_core_model_extension_worker_1   ... done
Removing poc_core_model_extension_redis_1    ... done
Removing poc_core_model_extension_nautobot_1 ... done
Removing network poc_core_model_extension_default
```
...
So for example, our plugin is named `poc-core-model-extension`, the command would most likely be `docker logs poc_core_model_extension_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("poc_core_model_extension")
namespace.configure(
    {
        "poc_core_model_extension": {
            ...
...
Or set the `INVOKE_POC_CORE_MODEL_EXTENSION_NAUTOBOT_VER` variable.
